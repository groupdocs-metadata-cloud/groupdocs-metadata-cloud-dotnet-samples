...
{
    /// <summary>
    /// This example demonstrates how to set metadata by match property name regex.
    /// </summary>
    public class SetMetadataByPropertyNameMatchRegex
    {
        public static void Run()
        {
            Console.WriteLine("Running SetMetadataByPropertyNameMatchRegex");
